        ...
        if ($this->runInSeparateProcess()) {
            ...
            if ($runEntireClass) {
                $template = new Template(
                    '/Users/esinergia/Sites/devdesktop/my-project/vendor/composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseClass.tpl'
                );
            } else {
                $template = new Template(
                    '/Users/esinergia/Sites/devdesktop/my-project/vendor/composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseMethod.tpl'
                );
            }
